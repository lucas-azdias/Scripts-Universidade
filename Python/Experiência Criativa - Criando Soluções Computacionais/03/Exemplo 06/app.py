...
hrefs = ["/clientes", "/pedidos", "/register_pedido", "/funcionarios", "/register_funcionario"]
...
# ]
empls = list()
# empls = ["Roberta Serra, garçom",
#          "Rodrigo Campos, garçom",
#          "Rogério Tempra, garçom",
#          "Robson Mustang, serviços gerais"
# ]
...
@app.route('/register_funcionario')
# Função para a página register_funcionario
def register_funcionario():
    return render_template("register_funcionario.html", hrefs=hrefs, descriptions=descriptions)
