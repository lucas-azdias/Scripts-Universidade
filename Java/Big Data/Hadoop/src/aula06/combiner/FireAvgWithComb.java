...
public class FireAvgWithComb implements WritableComparable<FireAvgWithComb> {
    private float somaTemperatura;
    private int ocorrencia;

    public FireAvgWithComb() {
    }

    public FireAvgWithComb(float somaTemperatura, int ocorrencia) {
    ...
    public boolean equals(Object o) {
        ...
        FireAvgWithComb that = (FireAvgWithComb) o;
    ...
    @Override
    public int compareTo(FireAvgWithComb o) {
